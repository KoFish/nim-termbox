...
#
const
  TB_KEY_F1* = 0x0000FFFF
  TB_KEY_F2* = 0x0000FFFE
  TB_KEY_F3* = 0x0000FFFD
  TB_KEY_F4* = 0x0000FFFC
  TB_KEY_F5* = 0x0000FFFB
  TB_KEY_F6* = 0x0000FFFA
  TB_KEY_F7* = 0x0000FFF9
  TB_KEY_F8* = 0x0000FFF8
  TB_KEY_F9* = 0x0000FFF7
  TB_KEY_F10* = 0x0000FFF6
  TB_KEY_F11* = 0x0000FFF5
  TB_KEY_F12* = 0x0000FFF4
  TB_KEY_INSERT* = 0x0000FFF3
  TB_KEY_DELETE* = 0x0000FFF2
  TB_KEY_HOME* = 0x0000FFF1
  TB_KEY_END* = 0x0000FFF0
  TB_KEY_PGUP* = 0x0000FFEF
  TB_KEY_PGDN* = 0x0000FFEE
  TB_KEY_ARROW_UP* = 0x0000FFED
  TB_KEY_ARROW_DOWN* = 0x0000FFEC
  TB_KEY_ARROW_LEFT* = 0x0000FFEB
  TB_KEY_ARROW_RIGHT* = 0x0000FFEA
...
proc change_cell*(x: cuint; y: cuint; ch: uint32; fg: uint16; bg: uint16)

const
    TB_INPUT_ESC* = 1
    TB_INPUT_ALT* = 2

proc select_input_mode*(mode: cint): cint {.discardable.}
...
proc poll_event*(event: var tb_event): cint =
  tb_poll_event(event.addr)

proc peek_event*(event: var tb_event; timeout : cuint): cint =
  tb_peek_event(event.addr, timeout)

proc blit*(x, y, w, h: cuint; cells: var seq[tb_cell]) =
